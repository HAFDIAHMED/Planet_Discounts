        ...
        child: StaggeredGridView.count(
          ...
          children: <Widget>[
            Padding(
              ...
              child:
                  mychart1Items("Ventes par jour", "421.3M", "+12.9% du Total"),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: myCircularItems("Produits", "68.7M"),
            ),
            Padding(
              padding: const EdgeInsets.only(right: 8.0),
              child: myTextItems("Total Vendu", "48.6M"),
            ),
            Padding(
              padding: const EdgeInsets.only(right: 8.0),
              child: myTextItems("Total Vendu/jr", "25.5M"),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: mychart2Items("Commandes", "0.9M", "+19% du Total"),
            ),
          ],
          staggeredTiles: [
